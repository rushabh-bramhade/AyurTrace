...
const HerbCard = ({ herb, rating }: HerbCardProps) => {
        ...
        <div className="p-4 space-y-2">
          <div className="flex items-center justify-between">
            ...
            {herb.integrityStatus === "verified" && (
              <ShieldCheck className="h-5 w-5 text-verified shrink-0" />
            )}
          </div>
            ...
            {rating && rating.count > 0 ? (
                  ...
                  <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                    <DialogHeader>
                      <DialogTitle className="flex items-center gap-2">
                        Reviews for {herb.herbName}
                        <Badge variant="outline" className="font-mono text-[10px]">{herb.id}</Badge>
                      </DialogTitle>
                    </DialogHeader>
                    <div className="mt-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <Dialog>
                  ...
                  <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                    <DialogHeader>
                      <DialogTitle>Reviews for {herb.herbName}</DialogTitle>
                    </DialogHeader>
                    <div className="mt-4">
                      <ReviewSection batchId={herb.id} />
                    </div>
