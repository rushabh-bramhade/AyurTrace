...
import { Package, ShieldCheck, Trash2 } from "lucide-react";
    ...
    <div className="space-y-4">
      {batches.map((batch) => (
        <div key={batch.id} className="bg-card rounded-xl border border-border p-5 flex flex-col sm:flex-row sm:items-center gap-4">
          ...
          <Button variant="outline" size="sm" onClick={() => handleDelete(batch.id, batch.batch_code)} className="text-destructive hover:text-destructive">
