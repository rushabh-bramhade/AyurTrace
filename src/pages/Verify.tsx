...
import { Search, QrCode, ShieldCheck, ShieldAlert } from "lucide-react";
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground max-w-lg mx-auto">
              Enter the batch ID from your product's QR code to verify its authenticity and view complete provenance data.
            </p>
          </div>
          ...
          <div className="flex gap-3 mb-8">
            ...
            <Button variant="hero" size="lg" onClick={handleVerify}>
              Verify
            </Button>
          </div>
                  ...
                  {result.processingSteps.map((step, i) => (
                    <div key={i} className="flex gap-4">
                      <div className="flex flex-col items-center">
                        ...
                        {i < result.processingSteps.length - 1 && (
